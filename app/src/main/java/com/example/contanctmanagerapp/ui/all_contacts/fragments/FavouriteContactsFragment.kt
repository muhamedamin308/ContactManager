...
import com.example.contanctmanagerapp.databinding.FragmentFavouriteContactsBinding
...
class FavouriteContactsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentFavouriteContactsBinding.inflate(inflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        contactsViewModel.allFavouriteContacts.observe(viewLifecycleOwner) { contacts ->
